package com.demo.spring.springselenium.page.visa;
...
public class VisaRegistrationPage extends Base {
    ...
    public void setCountryFromAndTo(String countryFrom, String counrtyTo) {
        new Select(this.fromCountry).selectByValue(countryFrom);
        new Select(this.toCountry).selectByValue(counrtyTo);
    }
    ...
    public String getConfirmationNumber() {
        this.wait.until(driver1 -> this.requestNumber.isDisplayed());
        return this.requestNumber.getText();
    }

    @Override
    public boolean isAt() {
        return this.wait.until(driver1 -> this.firstName.isDisplayed());
    }
}
